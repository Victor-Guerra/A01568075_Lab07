...
public class GreetingRestControllerTest {
	...
	public void givenARequest_whenProvidedName_thenGoodbyeName() throws Exception {
		this.mockMvc.perform(get("/goodbye?name=Victor"))
			.andExpect(status().isOk())
			.andExpect(jsonPath("content", equalTo("Goodbye, Victor!")));
	}
	
	@Test
	public void givenARequest_whenNullName_thenGoodbyeWorld() throws Exception {
